...
This is a small package to experiment with and train multiple models in a structured,
but very flexible framework with the famous Caret API using a bare minimum of code.

## Installation
`modelgrid` can be installed from CRAN with `install.packages('modelgrid')`. If you want
