...
This is a small package to train multiple models in a structured
framework using the famous Caret API and a bare minimum of code.

## Installation

`modelgrid` can be installed from CRAN with `install.packages('modelgrid')` (soon). If you want
...
* `shared_settings`: settings to be shared across models. Obvious choices could be the ones
of target variable, features or resampling scheme.
